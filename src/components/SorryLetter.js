  ...
  const fullLetter = () => {
    return (
      <>
        ...
        <p><strong>{perpetrator}</strong> is working hard to correct this character flaw and the whole team will be supporting them wherever they can with this endeavour.</p>
